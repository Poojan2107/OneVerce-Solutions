      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12 relative z-10">
        <div className="mb-12 lg:mb-24">
          ...
          >
            ...
            <h2 className="text-4xl sm:text-6xl lg:text-8xl text-white uppercase font-black tracking-tighter leading-[1.1] sm:leading-none break-normal hyphens-none" style={{ wordBreak: 'keep-all' }}>
