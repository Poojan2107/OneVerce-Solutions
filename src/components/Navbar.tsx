          ...
          <Magnetic>
            ...
            >
              ...
              <div className='flex flex-col min-w-0'>
                <span className='text-lg sm:text-xl font-bold tracking-tighter uppercase text-white leading-none'>
                  Oneverce
                </span>
                <span className='text-[9px] uppercase tracking-[0.4em] sm:tracking-[0.6em] text-[#00f0f0] font-mono opacity-60'>
                  Systems_Studio
                </span>
              </div>
            </a>
