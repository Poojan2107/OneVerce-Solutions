...
const steps = [
  {
    ...
    description:
      'Deconstructing infrastructure and market positioning to identify revenue leakage.',
  },
  {
    number: '02',
    phase: 'Strategy_Beta',
  ...
  },
  {
    ...
    description:
      'Accelerated engine development via next-gen frameworks and absolute clean architecture.',
  },
  {
    number: '04',
    phase: 'Launch_Omega',
    ...
    description:
      'Transition into production with real-time performance tracking and autonomous scaling.',
  },
]
...
const Process = memo(function Process() {
  return (
    <section
      id='process'
      className='py-16 sm:py-24 md:py-48 bg-[#050505] relative overflow-hidden border-t border-white/5 bg-blueprint'
    >
      {/* Background Polish */}
      ...
      <div className='max-w-7xl mx-auto px-6 md:px-12 relative z-10'>
        <div className='mb-12 flex flex-col md:flex-row md:items-end justify-between gap-10'>
          ...
          <p className='text-zinc-400 text-base sm:text-xl max-w-sm leading-relaxed font-medium tracking-wide'>
            Precision multi-phase execution. Engineered for{' '}
            <span className='text-white font-semibold'>predictable scale</span>.
          </p>
        </div>
        ...
        <div className='grid md:grid-cols-2 lg:grid-cols-4 gap-6 relative'>
          ...
          {steps.map((step, index) => (
            ...
            >
              ...
              <h3 className='text-2xl sm:text-3xl font-bold mb-4 sm:mb-8 tracking-tighter text-white group-hover:translate-x-2 transition-transform duration-700 uppercase'>
                {step.title}
              </h3>
