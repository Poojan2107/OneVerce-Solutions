...
const caseStudiesList: CaseStudy[] = [
  {
    ...
    brief:
      'Engineering simulator modules capable of resolving 5,000+ credit evaluations with real-time feedback loops.',
    metrics: [
    ...
    challenge:
      'Handling dynamic, nested form entries that recalculate entire amortization grids on every key press caused major typing lag and UI dropouts.',
    solution:
      'Implemented component-level memoization, deferred calculation states using debounced updates, and offloaded graph redraws to a canvas-based rendering engine.',
    outcomes: [
  ...
  },
  {
    ...
    brief:
      'Bridging enterprise relational databases with offline-first client dashboards during transaction spikes.',
    metrics: [
    ...
    challenge:
      'Multiple distributors modifying inventory simultaneously caused out-of-sync indicators and double-booking errors.',
    solution:
      'Designed an event-driven synchronization channel using WebSockets with automatic SQLite-backed local cache failover and queue reconciliation.',
    outcomes: [
  ...
  },
  {
    ...
    brief:
      'Systematically restructuring checkout flows and lazy loading to boost conversion rates and SEO visibility.',
    metrics: [
    ...
    stack: [
      ...
      'Preloading directives',
    ],
    challenge:
      'High cart abandonment rate caused by slow checkout loading on mobile networks and excessive bundle sizes.',
    solution:
      'Audit of Web Vitals, conversion layout shifts, lazy loading of images, bundling Stripe library script triggers, and optimizing fonts.',
    outcomes: [
          ...
          {caseStudiesList.map(study => (
            ...
            >
              ...
              <div className='space-y-6'>
                ...
                <p className='text-zinc-500 text-xs font-medium leading-relaxed'>{study.brief}</p>
