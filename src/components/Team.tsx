...
import { Cpu, Terminal, Calendar, Code2, Shield, Sparkles, Linkedin, Award, ExternalLink } from 'lucide-react';
    ...
    timeline: [
      {
        ...
        description: 'Engineered the core high-performance boilerplate, micro-haptics system, and automated deployment matrix.',
      ...
      },
      {
        ...
        description: 'Designed credit kwalification dashboard simulators handling high-volume mock evaluations.',
      ...
      },
      {
        ...
        description: 'Engineered robust local database syncing and kitchen order ticket websocket dispatchers.',
      ...
      },
      {
        ...
        description: 'Mastered sub-second rendering, viewport optimization, and complex state lifecycles.',
    ...
    timeline: [
      {
        ...
        description: 'Established complete structural layouts, color palettes, and glassmorphism standards.',
      ...
      },
      {
        ...
        description: 'Crafted the layout hierarchy, predictive data interfaces, and inventory tables.',
      ...
      },
      {
        ...
        description: 'Optimized conversion workflows leading to a verified 4.2x increase in checkouts.',
...
export default function Team() {
  ...
  const accentBorderClass = currentFounder.accent === 'blue' ? 'border-blue-500/30' : 'border-purple-500/30';
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-16">
          <div className="flex items-center justify-center gap-3 mb-6">
            ...
            <span className="text-zinc-500 font-bold uppercase tracking-[0.5em] text-[10px]">Command Dossier</span>
          </div>
          ...
          <p className="text-zinc-400 text-base sm:text-xl max-w-xl mx-auto leading-relaxed font-medium">
            Explore the historical timeline, technological stack adoption, and system architecture records of our founders.
          </p>
        </div>
            ...
            <div className="relative pl-6 border-l border-white/5 ml-4 space-y-6">
              {currentFounder.timeline.map((evt, idx) => (
                ...
                >
                  ...
                  <div className={`absolute -left-[31px] top-1.5 w-4 h-4 rounded-full border-2 bg-[#050505] flex items-center justify-center transition-all duration-300 ${
                    activeEventIdx === idx 
                    ? currentFounder.accent === 'blue' ? 'border-blue-500 scale-110' : 'border-purple-500 scale-110'
                  ...
                  <div className={`p-4.5 rounded-xl border transition-all ${
                    ...
                    <div className="flex items-center justify-between flex-wrap gap-2">
                      <span className={`font-mono text-xs font-bold ${accentColorClass}`}>{evt.year}</span>
                      <span className="text-[9px] font-black uppercase tracking-wider text-zinc-600">{evt.domain}</span>
                    </div>
                ...
                >
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[10px] font-black text-zinc-500 uppercase tracking-widest">Selected Milestone</span>
                    </div>

                    <div>
                      <span className={`text-[10px] font-black uppercase tracking-[0.25em] ${accentColorClass}`}>
                        {activeEvent.year} // {activeEvent.domain}
                      </span>
                    ...
                    <div className="space-y-3 pt-6 border-t border-white/5">
                      <div className="text-[9px] font-black uppercase tracking-widest text-zinc-500">Milestone Stack Matrix</div>
                      <div className="flex flex-wrap gap-2">
                        {activeEvent.tech.map(t => (
                          <span key={t} className="text-[9px] font-bold uppercase tracking-wider px-3 py-1.5 rounded-full bg-white/[0.04] border border-white/5 text-zinc-300">
                            {t}
                          </span>
                        ))}
                      </div>
