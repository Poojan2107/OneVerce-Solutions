...
const founderData: FounderTimeline[] = [
  ...
  },
  {
    ...
    timeline: [
      {
        year: '2026',
        title: 'Launched OpenBridge AI Onboarding Mentor',
        domain: 'Lead Developer',
        description:
          'Developed the complete React + Express platform, integrating 3 Gemini AI endpoints and Prisma database schema to onboard open-source contributors.',
        tech: ['React 19', 'Express', 'SQLite', 'Prisma', 'Gemini AI'],
      },
      {
        year: '2025',
        ...
        description:
          'Built the MERN stack hardware inventory system, detailing multi-location logs and dynamic charts.',
        tech: ['MongoDB', 'Express', 'React', 'Node', 'Recharts'],
      },
      {
        year: '2024',
        title: 'Travelling Tent Booking Portal',
        domain: 'MERN Developer',
        description:
          'Implemented booking forms, Stripe payments, and reservation management calendars.',
        tech: ['NodeJS', 'Express', 'MongoDB', 'EJS'],
      },
      {
        year: '2023',
        title: 'Academic DSA & Core Programming',
        domain: 'B.Tech AI Student',
        description: 'Mastered Java, Python, C/C++, object-oriented design, and algorithms.',
        tech: ['Python', 'Java', 'C++', 'DSA', 'OOPs'],
      },
    ],
  },
]
