    ...
    <section className='py-16 sm:py-24 md:py-48 bg-black relative overflow-hidden border-t border-white/5 bg-blueprint'>
      ...
      <div className='absolute inset-0 pointer-events-none overflow-hidden'>
        <div
          ...
          style={{
            background:
              'linear-gradient(to left, rgba(168,85,247,0.06), rgba(236,72,153,0.04), transparent)',
          }}
        />
        <div
          className='absolute -bottom-20 left-0 w-125 h-125 rounded-full blur-[160px]'
          style={{ background: 'rgba(59,130,246,0.06)' }}
        />
        <div
          className='absolute top-1/3 right-1/3 w-80 h-80 rounded-full blur-[130px]'
        ...
        <div className='grid lg:grid-cols-2 gap-10 lg:gap-24 items-center'>
          ...
          >
            ...
            >
              ...
              <span className='text-pink-300 text-[8px] sm:text-[10px] font-black uppercase tracking-[0.2em] sm:tracking-[0.45em]'>
            ...
            >
              ...
              <span
                ...
                style={{
                  background:
                    'linear-gradient(90deg, #f472b6 0%, #a855f7 45%, #818cf8 80%, #60a5fa 100%)',
            ...
            <p className='text-zinc-400 text-base md:text-lg mb-10 max-w-md leading-relaxed font-medium'>
              ...
              <span
                ...
                style={{
                  ...
                  textDecorationColor: 'rgba(236,72,153,0.5)',
            ...
            <div
              className='flex items-center gap-2 sm:gap-3 mb-10 px-3 py-2 sm:px-4 sm:py-3 rounded-2xl w-fit max-w-full'
              style={{
            ...
            >
              <div className='flex items-center gap-1.5 shrink-0'>
                ...
                />
                <span className='text-[9px] font-black text-red-400 uppercase tracking-[0.2em] sm:tracking-[0.4em]'>
                  Live
                </span>
              </div>
              <div className='w-[1px] h-4 bg-white/10 shrink-0' />
              <span className='text-[8px] sm:text-[9px] font-bold text-zinc-500 uppercase tracking-normal sm:tracking-widest truncate'>
          ...
          >
            {/* Outer glow */}
            <div
              className='absolute inset-[-10px] sm:inset-[-30px] rounded-[3rem] pointer-events-none blur-[80px] opacity-25'
              style={{
                background:
                  'radial-gradient(ellipse, rgba(168,85,247,0.5) 0%, rgba(236,72,153,0.3) 50%, transparent 80%)',
              }}
            />

            {/* Broadcast frame */}
            <div
              className='relative rounded-[1.5rem] sm:rounded-4xl overflow-hidden'
              style={{
            ...
            >
              ...
              >
                ...
                />
                <span className='text-[9px] font-black text-red-400 uppercase tracking-[0.35em]'>
                  On Air
                </span>
              </div>
              ...
              <div className='flex gap-[3px] h-full px-[3px]'>
                ...
                <div className='flex-1 overflow-hidden'>
                  <div
                    className='col-up flex flex-col gap-[3px]'
                    style={{ '--dur': '22s' } as React.CSSProperties}
                  >
                    {colA.map((src, i) => (
                      <div
                        key={i}
                        className='relative flex-shrink-0 aspect-[3/4] overflow-hidden rounded-lg group'
                      >
                        <img
                          src={src}
                          alt='Oneverce creative'
                          loading='lazy'
                ...
                <div className='flex-1 overflow-hidden'>
                  <div
                    className='col-down flex flex-col gap-[3px]'
                ...
                <div className='hidden sm:flex flex-1 overflow-hidden'>
                  <div
                    className='col-up flex flex-col gap-[3px] w-full'
              ...
              <div
                className='absolute bottom-0 left-0 right-0 z-30 px-5 py-4 flex items-center justify-between'
