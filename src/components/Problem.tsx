...
import { TrendingDown, Palette, MousePointerClick } from 'lucide-react'
...
const painPoints = [
  {
    ...
    description:
      'Every millisecond of latency is a potential exit point. We eliminate technical lag to ensure your traffic converts at peak efficiency.',
  },
  {
    icon: <Palette className='w-5 h-5 text-red-500' />,
    title: 'Generic design',
    description:
      'Template-based identities project mediocrity. We engineer custom, high-fidelity visual systems that command market authority.',
  },
  {
    icon: <MousePointerClick className='w-5 h-5 text-red-500' />,
    title: 'UX roadblocks',
    description:
      'Complex navigation kills intent. We optimize every interaction to ensure a friction-less path from landing to transaction.',
  },
]
        ...
        <div className='grid lg:grid-cols-[1.2fr_1fr] gap-12 lg:gap-20 items-start'>
          <div className='lg:sticky lg:top-24'>
            ...
            <h2 className='heading-2xl text-white uppercase mb-6 sm:mb-12 leading-[1.1] break-normal font-black tracking-tighter'>
              System
              <br />
              <span className='text-red-500 text-glow'>Failure</span>
              <br />
              Identified.
            </h2>

            <p className='text-zinc-400 text-base sm:text-xl leading-relaxed mb-8 sm:mb-12 max-w-lg tracking-wide font-medium'>
              Traffic hitting technical dead-ends results in{' '}
              <span className='text-red-400 font-bold'>40%</span> ad spend waste. We stop revenue
              leakage through engineered precision.
            </p>
              ...
              <div className='relative glass-card p-5 sm:p-8 rounded-2xl overflow-hidden border border-white/5'>
                ...
                <div className='mt-4 sm:mt-6 flex items-center gap-3 sm:gap-4 pl-4 sm:pl-6'>
                  ...
                  <div>
                    ...
                    <div className='text-zinc-500 text-[10px] uppercase tracking-[0.3em] font-bold'>
                      Business Director
                    </div>
                  </div>
                </div>
