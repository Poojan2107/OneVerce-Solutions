  ...
  useEffect(() => {
    ...
    const logInterval = setInterval(() => {
      if (logIndex < startupLogs.length) {
        setLogs(prev => [
          ...prev,
          `[${new Date().toLocaleTimeString([], { hour12: false, hour: '2-digit', minute: '2-digit', second: '2-digit' })}] ${startupLogs[logIndex]}`,
        ])
        logIndex++
          ...
          <div className='max-w-md w-full space-y-6 sm:space-y-12'>
            ...
            <div className='flex flex-col items-center gap-6'>
              ...
              <div className='text-center space-y-2'>
                <h1 className='text-white text-xl font-black uppercase tracking-[0.4em]'>
                  Oneverce
                </h1>
                <p className='text-[#00f0ff] text-[9px] font-bold uppercase tracking-[0.6em] animate-pulse'>
                  Systems Studio
                </p>
              </div>
            </div>
