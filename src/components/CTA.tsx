        ...
        >
          ...
          <div className='relative z-10 space-y-8'>
            ...
            <p className='text-zinc-400 text-sm sm:text-base md:text-xl max-w-2xl mx-auto leading-relaxed sm:leading-loose font-medium tracking-wide'>
              Deploy AI-native systems engineered to command your market.{' '}
              <span className='text-white font-semibold text-glow'>Scale without friction.</span>
            </p>

            <div className='pt-6'>
              <a
                href='#contact'
                className='inline-flex items-center gap-3 bg-white text-black px-6 py-3.5 sm:px-8 sm:py-4 rounded-full font-bold uppercase tracking-wider sm:tracking-widest text-[9px] sm:text-[10px] hover:scale-105 transition-all active:scale-95 group/btn shadow-lg relative overflow-hidden'
              >
