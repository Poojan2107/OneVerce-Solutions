      ...
      <div className='max-w-7xl mx-auto px-6 md:px-12 relative z-10'>
        <div className='grid lg:grid-cols-12 gap-10 sm:gap-20 mb-12 sm:mb-24'>
          <div className='lg:col-span-5 space-y-12'>
            ...
            <p className='text-zinc-400 text-lg leading-loose max-w-sm font-medium tracking-wide'>
              Engineering AI-native infrastructure. We build operational command centers for scaling
              enterprises.
            </p>
            ...
            <div className='flex gap-4'>
              {[
                { icon: <Instagram size={18} />, link: 'https://www.instagram.com/oneverce/' },
                {
                  ...
                  link: 'https://linkedin.com/in/vansh-prajapati-6a1749360/',
                },
          ...
          <div className='lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 sm:gap-12'>
            <div className='space-y-8'>
              <h4 className='text-[10px] font-bold text-white uppercase tracking-[0.4em]'>
                Company
              </h4>
        ...
        <div className='pt-12 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-8'>
          <div className='flex items-center gap-6 text-[9px] font-bold text-zinc-500 uppercase tracking-[0.3em]'>
            ...
            <span className='flex items-center gap-2'>Built by Vansh & Poojan</span>
          </div>
