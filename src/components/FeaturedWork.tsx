          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className={`space-y-6 ${index % 2 === 1 ? 'lg:order-1' : ''}`}>
                ...
                {/* Title */}
                <h3 className="text-2xl sm:text-3xl md:text-4xl lg:text-3xl xl:text-4xl 2xl:text-5xl font-black tracking-tighter text-white uppercase leading-[1.1] lg:leading-[0.9] break-normal">
                  {project.title}
                </h3>
