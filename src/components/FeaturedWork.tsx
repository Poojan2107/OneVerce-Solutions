          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className={`space-y-4 md:space-y-6 ${index % 2 === 1 ? 'lg:order-1' : ''}`}>
                ...
                {/* Title */}
                <h3 className="text-xl sm:text-2xl md:text-4xl lg:text-3xl xl:text-4xl font-black tracking-tighter text-white uppercase leading-[1.1] break-words">
                  {project.title}
                </h3>
                ...
                {/* Metrics */}
                <div className={`grid grid-cols-3 gap-3 md:gap-6 pt-4 md:pt-5 border-t border-white/[0.06]`}>
