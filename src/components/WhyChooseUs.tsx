...
const WhyChooseUs = memo(function WhyChooseUs() {
  ...
  return (
    <section
      id='about'
      className='py-16 sm:py-24 md:py-48 overflow-hidden bg-[#0a0c10] relative bg-blueprint'
    >
        ...
        <div className='grid lg:grid-cols-[1.2fr_1fr] gap-12 lg:gap-20 items-start'>
          ...
          >
            ...
            <p className='text-zinc-400 text-base sm:text-xl mb-12 max-w-xl leading-relaxed font-medium tracking-wide'>
              Architecting <span className='text-white font-semibold'>digital command centers</span>{' '}
              that enforce market leadership.
            </p>
            ...
            <div className='grid sm:grid-cols-2 gap-6'>
              {reasons.map((reason, index) => (
                ...
                >
                  ...
                  <p className='text-zinc-400 text-sm sm:text-base leading-relaxed font-medium group-hover:text-zinc-200 transition-colors'>
                    {reason.description}
                  </p>
                </motion.div>
              ))}
          ...
          >
            ...
            <div className='grid grid-cols-2 sm:grid-cols-4 gap-3'>
              {stats.map((stat, i) => (
                ...
                >
                  <div
                    className={`text-2xl font-black tracking-tighter mb-0.5 transition-colors duration-300 ${stat.color}`}
                  >
                    {stat.value}
                  </div>
